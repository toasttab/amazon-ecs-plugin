...
public class ECSTaskTemplateTest {
    ...
    ECSTaskTemplate getParent() {
        return new ECSTaskTemplate(
                ...
                "parent-containerUser", "parent-kernelCapabilities", null, new ArrayList<>(), null, null, null, null, null, null,null, null, null, null, 0, false, false);
    }
    ...
    ECSTaskTemplate getChild(String parent) {
        return new ECSTaskTemplate(
                ...
                false, null, 0, 0, 0, null, null, null, false, false,
                "child-containerUser", "child-kernelCapabilities", null, new ArrayList<>(), null, null, null, null, null, null,null, null, null, parent, 0, false, false);
    }
    ...
    public void shouldMerge() throws Exception {
        ...
        ECSTaskTemplate expected = new ECSTaskTemplate(
            ...
            null, null, null, "child-image", "child-repository-credentials", "EC2", "LINUX", "X86_64",false, null, "child-network-mode", "child-remoteFSRoot",
            false, null, 0, 0, 0, null, null, null, false, false,
            "child-containerUser", "child-kernelCapabilities", null, new ArrayList<>(), null, null, null, null, null, null,null, null, null, null, 0, false, false);
